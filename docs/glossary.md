# docs/glossary.md - Kamus Istilah coupon-aggregator
...
- **Apa ini?** Kamus istilah domain proyek coupon-aggregator. Tempat rujukan tunggal
...
|-------|---------|--------|-----------|
| 1 | 2026-06-30 | [TBD: <nama>] | Inisialisasi template glossary. |
