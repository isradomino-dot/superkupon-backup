 ...
 * kalau logged in.
 *
 * Placement: header bar public site (layout.tsx).
 */
export function UserMenu() {
  ...
  // Hydrate from localStorage + verify token via /auth/me background
  useEffect(() => {
    if (isMemberLoggedIn()) {
      const cached = getMemberUser();
      if (cached) setUser(cached);
      // Background verify — kalau token expired, akan auto-clear
